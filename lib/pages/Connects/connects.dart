...
class _DonationRequestState extends State<DonationRequest> {
  ...
  final TextEditingController numberDonorsRequired = TextEditingController();
  ...
  addDonationRequest() async {
    ...
    int parsedNumberDonorsRequired;
    try {
      parsedNumberDonorsRequired = int.parse(numberDonorsRequired.text);
    } catch (e) {
      print("Error parsing numberDonorsRequired: $e");
      return;
    }
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            onChanged: (newValue) {
                              setState(() {
                                ...
                                // يمكنك أيضًا تحديث الـ TextEditingController إذا كنت لا تزال بحاجة إليه
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  // عنصر نصي عادي
                                                  "الطول : $userHeight | الوزن : $userWeight | العمر $userAge", // تحديد النص
                                                  style: TextStyle(
                                                    // تحديد السمات
                                                    fontSize: width! * 0.04, // تحديد حجم الخط
                                                    color: AppTheme.tripCardLocationColor, // تحديد لون النص
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Text(
                                                    // عنصر نصي عادي
                                                    "أوقات العمل من الاحد الا الخميس من الساعه 9 الصباح الا 3 المساء", // تحديد النص
                                                    style: TextStyle(
                                                      // تحديد السمات
                                                      fontSize: width! * 0.04, // تحديد حجم الخط
                                                      color: AppTheme.tripCardLocationColor, // تحديد لون النص
