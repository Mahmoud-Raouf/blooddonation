...
import 'package:blooddonation/util/hexcode.dart';
...
class AppTheme {
  ...
  static Color themeColor = HexColor('#D60033');
  ...
  static Color colorRed = HexColor('#D60033');
  ...
  static Color buttonThemeColor = HexColor('#D60033');
  ...
  static Color customFocusColor = HexColor('#D60033');
  ...
  static Color customButtonBgColor = HexColor('#D60033');
  ...
  static List<Color> tutorialBgColor = [
    HexColor('#D60033'),
    HexColor('#e51a6e').withOpacity(0.8),
    HexColor('#ca3568').withOpacity(0.6)
  ];
